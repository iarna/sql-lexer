...
SQLite.TokenMatcherL0 = require('./sqlite/token-matcher-L0.js')(SQLite);
SQLite.TokenMatcherL1 = require('./sqlite/token-matcher-L1.js')(SQLite);
SQLite.Lex            = require('./sql92/lexer.js')(SQLite);
SQLite.keyword        = require('./sqlite/keywords.js')(SQLite);
SQLite.toSQL          = require('./sqlite/token-to-sql.js')(SQLite);
